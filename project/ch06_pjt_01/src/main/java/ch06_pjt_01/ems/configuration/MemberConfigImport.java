...
@Import({MemberConfig2.class, MemberConfig3.class})//배열형태로 임포트해줌 메인클래스컨피그 부분도 수정해줌
public class MemberConfigImport {// xml파일내용을 xml을 이용하지않고 전부 자바파일로 만들어서 아노테이션이용하기
//xml에서는 주로 빈을 만듦
