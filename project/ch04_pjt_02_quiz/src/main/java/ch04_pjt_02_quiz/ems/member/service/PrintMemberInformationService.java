...
public class PrintMemberInformationService {
	AllMemberSelectService allMemberSelectService;
	
	public PrintMemberInformationService(AllMemberSelectService allMemberSelectService) {
		this.allMemberSelectService  = allMemberSelectService;
	}
	
	public void printMembersInfo() {
		Map<String, Member> allMember = allMemberSelectService.allSelect();
